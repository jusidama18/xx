...
from bot import TELEGRAM_HASH, TELEGRAM_ID, AUTH_CHANNEL, BOT_TOKEN
...
def start(update, context):
    start_string = f'''
<b>Hey {update.message.chat.first_name}</b>
...
def restart(update, context):
    restart_message = sendMessage("Restarting bot now, Please wait until bot ready to use!", context.bot, update)
...
def main():
    ...
    if path.exists('restart.pickle'):
        ...
        restart_message.edit_text("Restarted Successfully, You can start mirror again!")
